...
<div class="page-header">
  <h1 class="text-titles"><i class="zmdi zmdi-book zmdi-hc-fw"></i> Administración <small>NUEVO ARCHIVO</small></h1>
</div>
...
<div class="panel panel-info">
	<div class="panel-heading">
		<h3 class="panel-title"><i class="zmdi zmdi-plus"></i> &nbsp; NUEVO ARCHIVO</h3>
	</div>
	<div class="panel-body">
		<form>
					...
					<div class="row">
						<div class="col-xs-12 col-sm-6">
					    	<div class="form-group label-floating">
							  	<label class="control-label">Código de Archivo *</label>
			...
			<br>
			<fieldset>
				<legend><i class="zmdi zmdi-labels"></i> &nbsp; Ubicacion</legend>
				<div class="container-fluid">
					<div class="row">
						<div class="col-xs-12 col-sm-6">
							<div class="form-group label-floating">
							  	...
							  	<select name="categoria-reg" class="form-control">
						          	<option value="empresa1">Anaquel 1</option>
						          	<option value="empresa2">Anaquel 2</option>
						        </select>
							</div>
	    				</div>
						<div class="col-xs-12 col-sm-6">
							<div class="form-group label-floating">
							  	<label class="control-label">anaquel</label>
							  	<select name="categoria-reg" class="form-control">
						          	<option value="categoria1">Anaquel 1</option>
						          	<option value="categoria2">Anaquel 2</option>
						        </select>
							</div>
	    				</div>
	    				<div class="col-xs-12 col-sm-6">
							<div class="form-group label-floating">
							  	...
							  	<select name="categoria-reg" class="form-control">
						          	<option value="categoria1">nivel 1</option>
						          	<option value="categoria2">nivel 2</option>
						        </select>
							</div>
	    				</div>
	    				<div class="col-xs-12 col-sm-6">
							<div class="form-group label-floating">
							  	<label class="control-label">N° Archivador</label>
							  	<select name="proveedor-reg" class="form-control">
						          	<option value="proveedor">Nivevl 1</option>
						          	<option value="proveedor">Nivel 2</option>
						        </select>
							</div>
	    				</div>
					</div>
